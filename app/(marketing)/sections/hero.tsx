...
export const HeroSection = ({}: HeroProps) => {
  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative mx-auto max-w-[23.25rem] md:max-w-5xl xl:mb-24">
          <div className="z-1 bg-conic-gradient relative rounded-2xl p-0.5">
            <div className="bg-n-8 relative rounded-[0.875rem]">
              ...
              <ScrollParallax isAbsolutelyPositioned>
                <ul className="border-n-1/10 absolute -left-[5.5rem] bottom-[7.625rem] hidden rounded-2xl border bg-[#474060]/40 px-1 py-1 backdrop-blur xl:flex">
                  {[
          ...
          <div className="z-1 relative mx-2.5 h-6 rounded-b-[1.25rem] bg-[#1B1B2E] shadow-xl lg:mx-8 lg:h-6"></div>
          <div className="z-1 relative mx-6 h-6 rounded-b-[1.25rem] bg-[#1B1B2E]/70 shadow-xl lg:mx-20 lg:h-6"></div>
          ...
          <div className="border-n-2/5 absolute -top-[42.375rem] left-1/2 aspect-square w-[78rem] -translate-x-1/2 rounded-full border md:-top-[38.5rem] xl:-top-[32rem]">
            <div className="border-n-2/10 absolute left-1/2 top-1/2 aspect-square w-[65.875rem] -translate-x-1/2 -translate-y-1/2 rounded-full border"></div>
            <div className="border-n-2/10 absolute left-1/2 top-1/2 aspect-square w-[51.375rem] -translate-x-1/2 -translate-y-1/2 rounded-full border"></div>
      ...
      <div className="h-0.25 bg-n-6 pointer-events-none absolute left-10 right-10 top-[55.25rem] hidden xl:block"></div>
      <svg
